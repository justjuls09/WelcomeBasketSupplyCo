...
st.write("Please fill out the form below to place your welcome basket order.")
st.subheader("Step 1: Enter your order details")
...
with left:
    ...
    st.write("Fill out the form below and click the button " \
    "to add your order to this session's history. " \
    "You can download a packing slip for each order, "
    "and export the entire session history as CSV when you're done.")
